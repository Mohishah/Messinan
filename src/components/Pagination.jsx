    ...
    return (
        <div className="container mil-p-0-120">
            ...
            <div className="mil-pagination">
                ...
                <Link key="pagination-item-next" href={currentPage < pages.length ? renderPageLink( parseInt(currentPage) + 1 ) : renderPageLink( currentPage )} className="mil-pagination-link mil-pagination-link--next">&raquo;</Link>
            </div>
            {/* pagination end */}
